    ...
    <>
      <svg
        className={`w-6 h-6 transition-all duration-500 ease-in-out ${
          status ? 'text-yellow-300 ' : 'text-gray-200 dark:text-gray-600'
        }`}
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
        fill="currentColor"
      ...
      <span className="sr-only">{status ? 'unfavorite' : 'favorite'}</span>
    </>
  )
}
...
export const WarningIcon = () => {
  return (
    <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-yellow-400 bg-orange-100 rounded-lg dark:bg-orange-400 dark:text-orange-200">
      <svg
        className="w-5 h-5"
        aria-hidden="true"
        xmlns="http://www.w3.org/2000/svg"
