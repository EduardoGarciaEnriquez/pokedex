...
function Toast() {
  ...
  return (
    <div className="fixed top-20 z-10 w-full flex justify-center ">
      <div
        id="toast"
        className={`flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg dark:text-gray-400 dark:bg-gray-700 shadow-md border border-${borderColor}-100 transition-all duration-1000 ease-in-out`}
        role="alert"
      >
        <ToastIcon />
